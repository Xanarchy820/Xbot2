...
Escribe ${prefix}verify para comenzar a usar el bot.`
let buff = await getBuffer(ppimg)
        ...
        try {
          ...
          ppimg = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
				...
				teks = `Eventualmente la carga del grupo se redujo en 1, adiós pedazo de aborto @${num.split('@')[0]}👋`
        let buff = await getBuffer(ppimg) 
				Lxa.sendMessage(mdata.id, teks, MessageType.text, {contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
  ...
  success: '*☉* Funciona',
  Public: '*☒* Características en modo privado ahora solo el propietario puede usar el bot',
  ferr: 'Lo siento, parece que la función tiene un error.',
  limitend: 'Lo sentimos, su límite se agotó, repita la compra.',
  error: {
  stick: '*☒* Inténtelo de nuevo en un momento.',
  Iv: '*☒* Error de enlace'
  },
  only: {
    group: '*☒* Esta función es solo para *GRUPO*',
    ownerG: '*☒* Esta función es solo para *PROPIETARIO DEL GRUPO*',
    ownerB: '*☒* Esta función es solo para *EL DUEÑO DEL BOT*',
    admin: '*☒* Esta función es solo para *ADMINISTRADORES DEL GRUPO*',
    Badmin: '*☒* Hacer al Bot *ADMIN!*',
    daftarB: `Hola, escriba *${prefix}verify* para empezar a usar el bot`
  }
}
...
if (getmemex <= memberlimit) {
  Lxa.sendMessage(from, `Lo sentimos, los requisitos para miembros deben estar arriba ${memberlimit}, Adiós 👋🏻`, text)
...
case 'menu':
hasil = `        ────────────────
Oye *${pushname}* intenta escribir ${prefix}menu
        ────────────────`
reply(hasil)
        break
}
...
〘 *BOT* 〙
‣ Prefijo:  *「 ${prefix} 」*
‣ Nombre: *Soy Xanarchy bot*
‣ WAConnection: *Baileys*
‣ Status online: *${kyun(uptime)}*
‣ Tipo: *ON*
‣ Grupo:  *${groupName}*
‣ Número de usuarios : *${_registered.length} Usuarios*
‣ Número de chats : *${totalchat.length} Chats*
      ────────────────
┏━━━━━━━━━━━━━━━━━━━━
┃─────〘 *Soy Xanarchy Bot V.2* 〙────
┃━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Simi (Texto)*
┃ _Simsimi Chat_
┠⊷️ *${prefix}Info*
...
┠⊷️ *${prefix}Owner*
┃ _Información del propietario del bot_
┠⊷️ *${prefix}Donasi*
┃ _Información de donación_
┠⊷️ *${prefix}Ping*
┃ _Conoce la velocidad de respuesta_
┗━━━━━━━━━━━━━━━━━━━━
┏━━━━━━━━━━━━━━━━━━━━
┃─────〘  *Lista del menu* 〙─────
┗━━━━━━━━━━━━━━━━━━━━
...
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Listadmin*
┃ _Muestra la lista de administradores_
┠⊷️ *${prefix}Listonline*
┃ _Muestra la lista de miembros en línea._
┠⊷️ *${prefix}Closegc*
┃ _Cerrar el grupo_
┠⊷️ *${prefix}Opengc*
┃ _Abrir el grupo_
...
┃ _Quitar admin_
┠⊷️ *${prefix}Setname*
┃ _Cambiar el nombre del grupo_
┠⊷️ *${prefix}Setdesk*
┃ _Cambiar la descripción del grupo_
┠⊷️ *${prefix}Add*
┃ _Agregar miembro_
┠⊷️ *${prefix}Kick*
┃ _Expulsar miembro_
...
┠⊷️ *${prefix}Linkgc*
┃ _Dar el enlace del grupo_
┠⊷️ *${prefix}Leave*
┃ _Quitar el bot del grupo_
┠⊷️ *${prefix}Notif*
...
┃ _Invertir la ortografía de las oraciones_
┠⊷️ *${prefix}Hilih (Texto)*
┃ _Cambiar las vocales a i_
┠⊷️ *${prefix}Namae (Texto)*
┃ _Nombre ninpushnameu_
┠⊷️ *${prefix}Pantun*
┃ _Rimas aleatorias_
┠⊷️ *${prefix}Bucin*
┃ _Palabras de bucin al azar_
┠⊷️ *${prefix}Bijak*
┃ _Palabras motivacionales aleatorias_
┠⊷️ *${prefix}Chatprank (Texto1/Texto2)*
┃ _Ej. : ${prefix}Charla de broma hola estallido/sat_
┠⊷️ *${prefix}Itsme*
┃ _Mostrar perfil_
┠⊷️ *${prefix}Fml*
┃ _Cotizaciones Fuck My Life_
┠⊷️ *${prefix}Asupan*
┃ _Vídeos de actualización de la cronología_
┠⊷️ *${prefix}Tagme*
┃ _Etiquetado automático_
...
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}listvn*
┃ _Muestra la lista del bot de vn_
┠⊷️ *${prefix}listimg*
┃ _Muestra la lista de fotos._
┠⊷️ *${prefix}liststik*
┃ _Muestra la lista de stickers del bot_
┠⊷️ *${prefix}listvid*
┃ _Muestra la lista de videos_
┠⊷️ *${prefix}Tupai (Respuesta de audio)*
┃ _Convierte la voz en ardilla_
┠⊷️ *${prefix}Slow (Respuesta de audio)*
┃ _Convierte la voz en tono bajo_
┠⊷️ *${prefix}Gemuk (Respuesta de audio)*
┃ _Convierte la voz en tono muy bajo_
┠⊷️ *${prefix}Bass (Respuesta de audio)*
┃ _Aumenta los graves de audio_
┗━━━━━━━━━━━━━━━━━━━━
*〘 EDICIÓN 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Gtav (Foto)*
┃ _Crea un banner de GTA V a partir de fotos_
┠⊷️ *${prefix}Wanted (Foto)*
┃ _Hace un póster de DESEADO a partir de fotos_
┠⊷️ *${prefix}Drawing (Foto)*
┃ _Filtro de foto de dibujo a lápiz_
┗━━━━━━━━━━━━━━━━━━━━
*〘 ANIME 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Kusonime (Nombre del anime)*
┃ _Busca información de anime en kusonime_
┠⊷️ *${prefix}Neonime (Nombre del anime)*
┃ _Busca información de anime en neonime_
┠⊷️ *${prefix}Charnime (Nombre del personaje de anime)*
┃ _Busca información de personajes de anime_
┠⊷️ *${prefix}Wait*
┃ _Detecta información de anime de una imagen_
┠⊷️ *${prefix}Anime*
┃ _Busca imagen de anime_
┠⊷️ *${prefix}Loli*
┃ _Busca imagen de anime loli_
┠⊷️ *${prefix}Neko*
┃ _Busca imagen de anime neko_
┗━━━━━━━━━━━━━━━━━━━━
*〘 JUEGO 〙*
┏━━━━━━━━━━━━━━━━━━━━
...
*〘 CONCHA MÁGICA 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷ *${prefix}Apakah (Es) (Texto)*
┠⊷ *${prefix}Bisakah (Lata) (Texto)*
┠⊷ *${prefix}Kapankah (Cuándo va a) (Texto)*
┠⊷ *${prefix}Rate (Velocidad) (Texto)*
┠⊷ *${prefix}Gantengcek (Guapo) (Texto)*
┠⊷ *${prefix}Cantikcek (Bastante cheque) (Texto)*
┗━━━━━━━━━━━━━━━━━━━━
*〘 HERRAMIENTAS 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Stiker*
┃ _Hacer stickers a partir de imágenes/gifts_
┠⊷️ *${prefix}Triggered*
┃ _Crea stickers activados_
┠⊷️ *${prefix}Wasted*
┃ _Hace stickers desperdiciados_
┠⊷️ *${prefix}Ttp (Texto)*
┃ _Crea stickers a partir de texto_
┠⊷️ *${prefix}Toimg*
┃ _Convierte stickers en imágenes_
┠⊷️ *${prefix}Tomp3*
┃ _Convierte video a audio_
┠⊷️ *${prefix}Play (Texto)*
┃ _Busca y envía canción_
┠⊷️ *${prefix}Tts (Texto)*
┃ _Texto a audio_
┠⊷️ *${prefix}Igstalk (Usuario)*
┃ _Stalking Instagram_
┠⊷️ *${prefix}Timer (Hora)*
┃ _Cronógrafo_
┠⊷️ *${prefix}Wame*
┃ _Crea un enlace wa.me_
┠⊷️ *${prefix}Nulis (Texto)*
┃ _Escribir en libro_
┠⊷️ *${prefix}Ocr*
┃ _Copiar texto en imágenes_
┠⊷️ *${prefix}Wait*
┃ _Información de anime de dibujos de anime_
┗━━━━━━━━━━━━━━━━━━━━
*〘 TEXTO 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Tahta (Texto)*
┃ _Ex : ${prefix}Tahta Xanarchy_
┗━━━━━━━━━━━━━━━━━━━━
*〘 TEXT2 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Ephoto list*
┃ _Mostrar el código de texto de la foto_
┠⊷️ *${prefix}Ephoto (Número + Texto)*
┃ _Ej : ${prefix}Ephoto 25 Xanarchy_
┠⊷️ *${prefix}Textpro list*
┃ _Mostrar código de texto textpro_
┠⊷️ *${prefix}Textpro (Número + Texto)*
┃ _Ej : ${prefix}Textpro 55 Xanarchy_
┗━━━━━━━━━━━━━━━━━━━━
*〘 FOTOS 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Cogan*
┃ _Foto al azar cogan_
┠⊷️ *${prefix}Cecan*
┃ _Foto aleatoria cecan_
┠⊷️ *${prefix}Meme*
┃ _Meme aleatorio_
┠⊷️ *${prefix}Twit*
┃ _Foto de estado de Twitter aleatoria_
┠⊷️ *${prefix}Quotes*
┃ _Citas de fotos al azar_
┠⊷️ *${prefix}Wp*
┃ _Fondo de pantalla aleatorio_
┠⊷️ *${prefix}Cyberpunk*
┃ _Fotos de cyberpunk al azar_
┠⊷️ *${prefix}Img (Consulta)*
┃ _Buscando imágenes por encargo_
...
┠⊷️ *${prefix}Tl (Texto/código idioma)*
...
┃ _Muestra sura en el Corán_
┠⊷️ *${prefix}Ngaji*
┃ _Verso aleatorio en la sura Al-Qur'an_
┠⊷️ *${prefix}Tafsir (Consulta)*
┃ _Buscando interpretaciones en el Corán_
...
┠⊷️ *${prefix}Ig (Link)*
┃ _Descargar videos de Instagram_
┠⊷️ *${prefix}Scdl (Link)*
┃ _Descarga la canción de SoundCloud_
┠⊷️ *${prefix}Tik (Link)*
┃ _Descargar videos de Tiktok_
┠⊷️ *${prefix}Pin (Link)*
┃ _Descargar videos de Pinterest_
┠⊷️ *${prefix}Joox (título de la canción*)
┃ _Descargar canciones en Joox_
┗━━━━━━━━━━━━━━━━━━━━
*〘 DUEÑO 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Clone*
┃ _Clonación de perfiles de destino de foros_
┠⊷️ *${prefix}Block*
┃ _Bloquear el número de destino_
┠⊷️ *${prefix}Unblock*
┃ _Desbloquea el número de destino_
┠⊷️ *${prefix}Bc*
...
//--Info bot
  ...
  ‣ *Total de usuarios* : ${_registered.length} User
...
Lxa.sendMessage(from, pok, image, {
  quoted: mek, caption: `Tomó una foto con éxito : *${tels}*`
})
...
Lxa.updatePresence(from, Presence.composing)
tw = ["Twitter divertido de Indonesia",
  "Twitter diario",
  "Subestimar Twitter",
  "tweets divertidos"]
...
case 'wallpaper':
  ...
  Lxa.updatePresence(from, Presence.composing)
  pw = ["fondos de pantalla aestethic",
"fondos de pantalla de tumblr",
...
method: 'get'
  ...
  pok = await getBuffer(nimek)
  Lxa.sendMessage(from, pok, image, {
quoted: mek, caption: `genial o no ?`
  })
...
method: 'get'
  ...
  pok = await getBuffer(nimek)
  Lxa.sendMessage(from, pok, image, {
quoted: mek, caption: `Pobre soltero`
  })
...
method: 'get'
  ...
  hasil = `‣ *Caracteristicas* : ${iya.result.karakteristik}\n‣ *Descripción* : ${iya.result.deskripsi}`
  Lxa.sendMessage(from, hasil, text, {
quoted: mek
  })
...
Lxa.sendMessage(from, hasil, video, {
  caption: 'Aquí hermano', quoted: mek
})
...
hasil = `‣ *Nombre de usuario* : ${hmm.result.username}\n‣ *Nombre completo* : ${hmm.result.fullname}\n‣ *Seguidores* : ${hmm.result.followers}\n‣ *Seguidos* : ${hmm.result.following}\n‣ *Biografía* : ${hmm.result.bio}\n‣ *Enlace* : https://www.instagram.com/${hmm.result.username}\n‣ Seguir: ${Ig}`
Lxa.sendMessage(from, buffer, image, {
  quoted: mek, caption: hasil
})
...
case 'rate':
  ...
  hasil = `Clasificación : *${body.slice(6)}*\n\nRespuesta : *${random}%*`
  reply(hasil)
  break
...
case 'kapankah':
  ...
  hasil = `Cuándo va a : *${body.slice(10)}*\n\nRespuesta : *${random2} ${random}*`
  reply(hasil)
  break
...
case 'kapan':
  ...
  random = kapankah[Math.floor(Math.random() * (kapankah.length))]
  random2 = `${Math.floor(Math.random() * 8)}`
  hasil = `Cuándo va a : *${body.slice(7)}*\n\nRespuesta : *${random2} ${random}*`
  reply(hasil)
  break
...
if (!isRegister) return reply(mess.only.daftarB)
if (!isGroup) return reply(mess.only.group)
teks = `Notificación de @${sender.split("@")[0]}\n*Mensaje : ${body.slice(7)}*`
...
Lxa.sendMessage(from, '*☉* Cambio de nombre del grupo', text, {
  quoted: mek
})
break
...
Lxa.sendMessage(from, '*☉* Cambio de la descripción del grupo', text, {
  quoted: mek
})
break
...
if (!isRegister) return reply(mess.only.daftarB)
const tagme = {
  text: `@${sender.split("@")[0]} Hola hermano`,
  contextInfo: {
mentionedJid: [sender]
  }
}
...
case 'kbbi':
  ...
  hasil = `DICCIONARIO DE INDONESIA\n\n${data.result}`
  reply(hasil)
...
case 'jadwaltv':
  ...
  ch = body.slice(10)
  if (args.length < 1) return reply('*☒* Ingrese un nombre de canal')
  Lxa.updatePresence(from, Presence.composing)
  reply(mess.wait)
  try {
...
method: 'get'
  ...
  hasil = `*Horario de television* : ${ch} hoy\n${n}`
  reply(hasil)
...
quoted: mek, caption: `Resultado de *${daerah}*`
  })
...
case 'alquran':
  ...
  if (args.length < 1) return reply('*☒* Ingrese el número de sura 1-114')
  if (isNaN(args.length < 1)) return await reply('Usa un número de sura')
  tels = body.slice(9)
  try {
...
method: 'get'
  ...
  teks = `
  〘  *${data.surah}*  〙
  Es surah ke ${data.no} en el Corán por el número de versos (${data.jumlah_ayat} ayat)
  ──────────────────────
...
case 'ytmp3':
  ...
  infomp3 = `*Audio encontrado!!!*\n‣ Título : ${anu.result.title}\n‣ *Fuente* : ${anu.result.source}\n‣ Tamaño : ${anu.result.size}\n\n_Enviando archivos por favor espere_\n\n_Si el video no aparece, descárguelo usted mismo usando el enlace a continuación_\n‣ *Enlace* : ${anu.result.link}`
...
case 'fb':
  ...
  reply(mess.wait)
  if(!isUrl(args[0]) && !args[0].includes('facebook')) return reply('Formato de enlace incorrecto, use el enlace de Facebook')
  play = body.slice(4)
  try {
...
case 'ig':
  ...
  reply(mess.wait)
    if(!isUrl(args[0]) && !args[0].includes('instagram')) return reply('Formato de enlace incorrecto, use el enlace de Instagram')
  play = body.slice(4)
  try {
  anu = await fetchJson(`http://lolhuman.herokuapp.com/api/instagram?apikey=${lolKey}&url=${play}`)
  lagu = await getBuffer(anu.result)
  Lxa.sendMessage(from, lagu, video, {
mimetype: 'video/mp4', filename: `ImXanarchy.mp4`, quoted: mek
  })
...
case 'tik':
  if (args.length < 1) return reply('*☒* Ingrese el enlace')
  if (!isRegister) return reply(mess.only.daftarB)
				  ...
				  case 's':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('end', function () {
								console.log('Finish')
								exec(`webpmux -set exif ${addMetadata('Xanarchy', 'Samu')} ${ran} -o ${ran}`, async (error) => {
						...
						await ffmpeg(`./${media}`)
							...
							.on('error', function (err) {
								...
								reply(`❌ Falló, en el momento de la conversión ${tipe} al sticker`)
							})
							.on('end', function () {
								console.log('Finish')
								exec(`webpmux -set exif ${addMetadata('Xanarchy', 'Samu')} ${ran} -o ${ran}`, async (error) => {
						...
						await removeBackgroundFromImageFile({path: media, apiKey: keyrmbg, size: 'auto', type: 'auto', ranp}).then(res => {
							...
							exec(`ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${ranw}`, (err) => {
								fs.unlinkSync(ranp)
								if (err) return reply(mess.error.stick)
								exec(`webpmux -set exif ${addMetadata('Xanarchy', 'Samu')} ${ranw} -o ${ranw}`, async (error) => {
									if (error) return reply(mess.error.stick)
					...
					/*} else if ((isMedia || isQuotedImage) && colors.includes(args[0])) {
						...
						reply(`Envía fotos con subtítulos ${prefix}sticker o etiqueta de imagen que se ha enviado`)
					}
					break
...
//-- temp
			...
			case 'addstik':
				...
				svst = body.slice(9)
				if (!svst) return reply('¿Cuál es el nombre del sticker?')
				boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
				delb = await Lxa.downloadMediaMessage(boij)
				setiker.push(`${svst}`)
				fs.writeFileSync(`./temp/stick/${svst}.webp`, delb)
				fs.writeFileSync('./temp/stik.json', JSON.stringify(setiker))
				Lxa.sendMessage(from, `Agregar éxito Sticker\nComprobar por camino ${prefix}liststik`, MessageType.text, { quoted: mek })
				break
			...
			case 'addvn':
				...
				Lxa.sendMessage(from, `Agregar éxito Audio\nComprobar por camino ${prefix}listvn`, MessageType.text, { quoted: mek })
				break
			...
			case 'addimg':
				...
				if (!isOwner) return reply(mess.only.ownerB)
				svst = body.slice(8)
				if (!svst) return reply('¿Cuál es el nombre de la imagen?')
				boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
				delb = await Lxa.downloadMediaMessage(boij)
				imagenye.push(`${svst}`)
				fs.writeFileSync(`./temp/foto/${svst}.jpeg`, delb)
				fs.writeFileSync('./temp/image.json', JSON.stringify(imagenye))
				Lxa.sendMessage(from, `Adición de video exitosa\nComprobar por camino ${prefix}listimage`, MessageType.text, { quoted: mek })
				break
			...
			case 'getimg':
				...
				Lxa.sendMessage(from, buffer, image, { quoted: mek, caption: `Resultado de la base de datos : ${namastc}.jpeg` })
				} catch {
				  reply('El paquete no está registrado')
				}
				break
			...
			case 'addvid':
			  if (!isOwner) return reply(mess.only.ownerB)
				if (!isQuotedVideo) return reply('Responder el video')
				svst = body.slice(8)
				if (!svst) return reply('El nombre del video')
				boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
				delb = await Lxa.downloadMediaMessage(boij)
				videonye.push(`${svst}`)
				fs.writeFileSync(`./temp/video/${svst}.mp4`, delb)
				fs.writeFileSync('./temp/vid.json', JSON.stringify(videonye))
				Lxa.sendMessage(from, `Adición de video exitosa\nComprobar por camino ${prefix}listvid`, MessageType.text, { quoted: mek })
				break
...
Lxa.updatePresence(from,
  Presence.composing)
if (!isRegister) return reply(mess.only.daftarB)
if (!isQuotedVideo) return reply('*☒* Responder video')
reply(mess.wait)
...
Lxa.sendMessage(from, 'Hecho : '+ keh, text, {
  quoted: mek
})
break
...
jawab = anu.result.jawaban
setTimeout(() => {
  Lxa.sendMessage(from, `*➸ Respuesta :* ${jawab}`, text, {
quoted: mek
  }) // ur cods
}, 30000) // 1000 = 1s,
setTimeout(() => {
...
//--google voice
				case 'tts':
					if (args.length < 1) return Lxa.sendMessage(from, '¿Qué código de idioma es, tío?', text, {quoted: mek})
					const gtts = require('./lib/gtts')(args[0])
					if (args.length < 2) return Lxa.sendMessage(from, '¿Dónde está el texto, tío?', text, {quoted: mek})
					dtt = body.slice(8)
					ranm = getRandom('.mp3')
					dtt.length > 600
...
case 'block':
  ...
  Lxa.sendMessage(from, `Número de bloqueados, comando recibido`, text, {
quoted: mek
  })
  break
...
case 'unblock':
  ...
  Lxa.sendMessage(from, `Desbloquear, Orden aceptada`, text)
  break
...
//--Hilih maker
				...
				case 'tiktokstalk':
					try {
						if (args.length < 1) return Lxa.sendMessage(from, '¿Dónde está el nombre de usuario?', text, {quoted: mek})
...
//clear all chat
				case 'clearall':
					...
					reply('Eliminar con éxito todos los chats :)')
					break
				case 'bc':
					if (!isOwner) return reply('Quién es usted?')
...
//--menaikan jabatan
      case 'promote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Usuario promovido @${mentioned[0].split('@')[0]} Como administrador fachero del grupo!`, mentioned, true)
...
//--menurunkan jabatan
				case 'demote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Usuario degradado @${mentioned[0].split('@')[0]} Como miembro del grupo, jaja, por gei!`, mentioned, true)
...
//--menambah member
				case 'add':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args.length < 1) return reply('Ingrese el número de destino')
...
//--list admin grup
				case 'listadmins':
				  case 'listadmin':
				    case 'adminlist':
					if (!isGroup) return reply(mess.only.group)
					teks = `Lista de los admis facheros del grupo *${groupMetadata.subject}*\nTotal : ${groupAdmins.length}\n\n`
					no = 0
...
//--Convert stiker to image
				case 'toimg':
					...
					exec(`ffmpeg -i ${medimg} ${ran}`, (err) => {
						...
						buffer = fs.readFileSync(ran)
						Lxa.sendMessage(from, buffer, image, {quoted: mek, caption: 'Esto ?'})
						fs.unlinkSync(ran)
					})
					break
...
aruga = body.slice(11)
if (!isRegister) return reply(mess.only.daftarB)
if (args.length < 1) return reply(`Que sueño es?\nContoh: ${prefix}significado de una serpiente`)
try {
...
//--Simsimi talk
				case 'simi':
					...
					if (anu.error) return reply('Simi no lo sé hermana')
					reply(anu.success)
					} catch {
					  reply(mess.ferr)
					}
...
case 'daftar':
  case 'register':
if (isRegister) return reply('Tu cuenta ha sido verificada')
...
tm = `la verificación está completa por favor escriba ${prefix}Menu para poder ver los comandos del bot`
reply(tm)
break
...
//--ganteng cekkkk
  case 'gantengcek':
if (args.length < 1) return reply('Ingrese el nombre del objetivo')
...
Lxa.sendMessage(from, 'Bastante cheque *'+cantik+'*\n\nRespuesta : '+ tik+'%', text, {
  quoted: mek
})
break
				...
				case 'welcome':
					...
					if (Number(args[0]) === 1) {
						if (isWelkom) return reply('Ya activo um')
						welkom.push(from)
						...
						fs.writeFileSync('./data/welkom.json', JSON.stringify(welkom))
						reply('Desactivó con éxito la función de bienvenida en este grupo')
					} else {
				...
				case 'clone':
					if (!isGroup) return reply(mess.only.group)
					if (!isOwner) return reply(mess.only.ownerB)
					if (args.length < 1) return reply('Etiqueta de destino')
  ...
  reply(`        ────────────────\nOye *${pushname}* !!!\nComando / Comando : *${prefix}${command}*\nNada en *${prefix}Menu*\n        ────────────────`)
				}
